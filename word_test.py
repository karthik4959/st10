...
def test_count_uppercase():
    ...
    expected_result = 4 # Expected out put
...
# Test case for the vowels count function
...
# Test case for the characters count including spaces function
...
# Test case for the word count function
